...
class RestaurantServiceTest {
    ...
    void createRestaurant_AddedToRepository() {
        restaurantService.createRestaurant("Ganesh", "123","0987654321", "Rajkot", "Nana Mauva");
    ...
    void createRestaurant_ObjectVerifying() {
        Restaurant restaurant = restaurantService.createRestaurant("Ganesh", "123","0987654321", "Rajkot", "Nana Mauva");
    ...
    void loginIntoRestaurant_Existing() {
        Restaurant createdrestaurant = restaurantService.createRestaurant("Ganesh", "123","0987654321", "Rajkot", "Nana Mauva");
